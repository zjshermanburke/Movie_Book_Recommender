...
Movie::Movie(const std::string &title, int times_watched, int user_rating, const std::string &mpa_rating)
: Media{title, times_watched, user_rating}, mpa_rating{mpa_rating}{
}

// Getters
const std::string &Movie::get_mpa_rating() const {return mpa_rating;}
int Movie::get_times_watched() const {return Media::get_times_consumed();}
// Setters
void Movie::set_mpa_rating(const std::string &mpa_rating){
